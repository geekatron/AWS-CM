...
*/
        ...
        */
        ...
        _getParsedTime: function(inst) {
            ...
            if ((inst.hours < inst.settings.hours.starts) || (inst.hours > inst.settings.hours.ends )) { inst.hours = 0; }
            // default to 0 minutes if minute is not valid
            if ((inst.minutes < inst.settings.minutes.starts) || (inst.minutes > inst.settings.minutes.ends)) { inst.minutes = 0; }
